...
pub fn format_images(data: Vec<u8>, num_images: usize) -> Vec<Vec<Vec<f32>>> {
...
pub fn flatten(squares: Vec<Vec<Vec<f32>>>) -> Vec<f32> {
...
pub fn success(prev: &Vec<bool>) -> f32 {
...
pub fn highest_index(output: Vec<f32>) -> u8 {
